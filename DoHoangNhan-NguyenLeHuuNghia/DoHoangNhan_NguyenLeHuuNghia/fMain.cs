...
namespace DoHoangNhan_NguyenLeHuuNghia
{
    public partial class fMain : Form
    {
        ...
        private void DisableButton()
        {
            if (currentBtn != null)
            {
                currentBtn.BackColor = Color.FromArgb(83, 39, 157);
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn thoát chương trình?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                float salary = accountLogin.Salary;
        ...
        private void InitializeTimer()
        {
            ...
            timer.Tick += new EventHandler(UpdateElapsedTime);
            timer.Start();
        }
        private void UpdateElapsedTime(object sender, EventArgs e)
        {
            ...
            lb_thoigian.Text = $"Thời gian hoạt động: {hours:D2}:{minutes:D2}:{elapsedSeconds:D2}";
        }
